package com.example.serenity.uihelpers;
...
public class CalendarDialog {
    ...
    public void setEventList(List<CalenderEventModel> eventList) {
    ...
    private class ViewPagerAdapter extends PagerAdapter {
        ...
        ViewPagerAdapter(Calendar selectedDate, List<CalenderEventModel> eventList) {
            mEventList = eventList;
        ...
        public Object instantiateItem(@NonNull ViewGroup collection, int position) {
            ...
            List<CalenderEventModel> eventList = getCalendarEventsOfDay(day);
        ...
        private List<CalenderEventModel> getCalendarEventsOfDay(Calendar day) {
            List<CalenderEventModel> eventList = new ArrayList<>();
    ...
    private class CalendarEventAdapter extends RecyclerView.Adapter<CalendarEventAdapter.ViewHolder>{
        ...
        private final List<CalenderEventModel> mCalendarEvents;

        CalendarEventAdapter(List<CalenderEventModel> events) {
    ...
    public interface OnCalendarDialogListener {
        void onEventClick(CalenderEventModel event);
    ...
    public static class Builder  {
        ...
        public Builder setEventList(List<CalenderEventModel> calendarEventList) {
    ...
    private static class CalendarDialogParams {
        ...
        List<CalenderEventModel> mEventList = new ArrayList<>();
